...
The system SHALL keep essential non-premium navigation actions available to restricted authenticated users.
...
The system MUST continue to protect premium features when the user has an expired subscription or insufficient subscription formula.
