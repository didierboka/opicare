          ...
          appBar: AppBar(
            ...
            leading: Padding(
              ...
              child: CircleAvatar(
                ...
                backgroundImage: user.userPic.startsWith('/') ? FileImage(File(user.userPic)) as ImageProvider : (user.userPic.isNotEmpty && user.userPic != 'null' && user.userPic != 'N/A' ? NetworkImage("https://opisms.com/ecarnet/upload/photo/${user.userPic}") : NetworkImage("https://opisms.com/ecarnet/upload/photo/default_profile.jpg")),
